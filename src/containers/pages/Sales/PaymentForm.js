...
export default function PaymentForm({
  ...
  console.log("lista de compra: ", data);
  const {
    handleSubmit,
    setValue,
    // reset,
  ...
  console.log("IdD del Cliente: ", idClient);
  console.log("Metodo de pago: ", methodPaymentSelect);
  ...
  return (
    ...
    >
      <form
        onSubmit={handleSubmit(handleDateForm)}
